...
var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
    var defaults = {
        ...
        */
        ...
        //Show item count after group name
    ...
    $scope.showGroupItemCount = self.config.showGroupItemCount;
...
angular.module("ngGrid").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("aggregateTemplate.html",
    ...
    "    <span class=\"ngAggregateText\">{{row.label CUSTOM_FILTERS}}<span ng-show=\"showGroupItemCount\"> ({{row.totalChildren()}} {{AggItemsLabel}})</span></span>\n" +
